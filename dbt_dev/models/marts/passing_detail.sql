...
final as (
    select
		...
		plays.qb_dropback,
		plays.qb_scramble,
		plays.pass_length_category,
		plays.pass_field_location,
		plays.air_yards,
		...
		plays.sack,
		plays.touchdown,
		plays.pass_touchdown,
		plays.return_touchdown,
    ...
    from plays
		...
		left join players on plays.passer_player_id = players.player_id
